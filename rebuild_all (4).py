    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="current-track-info d-flex align-items-center flex-grow-1 me-3">
          <img id="current-cover" src="./images/avatar.jpg" alt="专辑封面" class="rounded me-2">
        ...
        <div class="progress-container flex-grow-1">
          <div class="d-flex align-items-center">
            ...
            <div id="progress-container" class="progress-bar flex-grow-1" style="height: 6px; background: rgba(255,255,255,0.3); border-radius: 3px; cursor: pointer;">
