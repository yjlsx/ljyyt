...
index_scripts_old = '''  <!-- 主脚本 -->
  <script src="script_fixed.js"></script>
</body>
</html>'''

index_scripts_new = '''  <!-- 主脚本 -->
...
index_content = index_content.replace(index_scripts_old, index_scripts)
...
<body>
    ...
    <div class="container">
      <div class="search-results-box" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border-radius: 15px; padding: 25px; margin-bottom: 25px;">
        ...
        <div class="alert alert-info mb-4" id="search-stats" style="display: none;">
          找到 <span id="total-count">0</span> 个结果 (<span id="music-count">0</span> 首音乐, <span id="video-count">0</span> 个视频)
        </div>
    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="volume-control d-flex align-items-center">
          ...
          <input type="id="range" id="volume-slider" class="form-range" min="0" max="1" step="0.01" value="0.7" style="width: 80px;">
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function formatTime(seconds) {
      ...
      var var sec = Math.floor(seconds % 60);
